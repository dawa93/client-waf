...
class Login extends React.Component {
  constructor(props) {
    ...
    this.NAVER_LOGIN_URL = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=Yn5blabiliLbi8Ed8Je4&state=waftest&redirect_uri=http://waf-client.s3-website.ap-northeast-2.amazonaws.com/users`;
